...
// import "../utlis/gradientInstagram.css";
// import "bootstrap/dist/css/bootstrap.min.css"; // در صورت استفاده از بوت‌استرپ
...
//                         <h5>دسترسی سریع</h5>
//                         <ul className="list-unstyled">
//                             <li><a href="#" className="text-muted text-decoration-none">درباره ما</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">تماس با ما</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">بلاگ</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">سوالات متداول</a></li>
//                         </ul>
//                     </div>
                    
//                     {/* دسته‌بندی‌ها */}
//                     <div className="col-md-3 mb-4 ">
//                         <h5 className="text-dark">دسته‌بندی‌ها</h5>
//                         <ul className="list-unstyled text-muted">
//                             <li><a href="#" className="text-muted text-decoration-none">غذاهای ایرانی</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">پیش‌غذاها</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">دسرها</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">غذاهای گیاهی</a></li>
//                             <li><a href="#" className="text-muted text-decoration-none">فست‌فودها</a></li>
//                         </ul>
//                     </div>
                    
//                     {/* شبکه‌های اجتماعی */}
//                     <div className="col-md-3 mb-4">
//                         <h5 className="mb-3">ما را دنبال کنید</h5>
//                         <div className="d-flex">
//                             <a href="#" className="text-white me-3 " aria-label="Instagram">
//                                 <i className="fa-brands fa-instagram gradient-box fs-4 "></i>
//                             </a>
//                             <a href="#" className=" me-3 " aria-label="Telegram">
//                                 <i className="fa-brands fa-telegram text-primary fs-4"></i>
//                             </a>
...
//                     {/* خبرنامه */}
//                     <div className="col-md-3 mb-4">
//                         <h5 className="mb-3">عضویت در خبرنامه</h5>
//                         <form className="d-flex flex-column">
//                             <label htmlFor="email" className="visually-hidden">ایمیل شما</label>
//                             <input 
//                                 type="email" 
...
//                 {/* کپی‌رایت */}
//                 <div className="text-center py-3 mt-3 border-top border-secondary">
//                     <p className="mb-0 text-muted">© 2024 کلیه حقوق برای سایت آشپزی محفوظ است.</p>
//                 </div>
//                 </>
